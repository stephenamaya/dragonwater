...
if(isset($_POST['submit'])){
 ...
 if (mysqli_num_rows($result) == 1){	//If at least one result
   ...
   echo "<h3>Account successfully created. Log in to get started! You will be redirected to the login page in 5 seconds.</h3>";
   $_SESSION['username'] = $user;
   header("Refresh: 4; url=index.php"); //Takes user to login page in 3 secs
 }
}
?>
